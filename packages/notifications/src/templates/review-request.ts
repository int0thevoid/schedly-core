...
export function reviewRequestTemplate(data: ReviewRequestData): EmailTemplate {
  ...
  const callToActionHtml = data.googleReviewLink
    ...
    : `<p style="margin:0 0 16px;font-size:15px;">Si quieres, puedes responder este correo contándonos tu experiencia. ¡Nos ayuda mucho a seguir mejorando!</p>`
  ...
  const bodyHtml = `
    ...
    <p style="margin:24px 0 0;font-size:15px;">¡Gracias por tu confianza!</p>
  `
